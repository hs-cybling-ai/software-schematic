# ArchiMate Diagram Editing

## Purpose

Provide local, editable ArchiMate diagram rendering, mutation tracking, XML persistence, compatibility verification, and isolated diagnostics.
